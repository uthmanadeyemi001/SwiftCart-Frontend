...
import { ShoppingCart, User, Home, Search, LogOut, Camera, Check } from 'lucide-react';
...
export default function Profile() {
  ...
  return (
    <div className="profile-page-container">
      ...
      {/* Clean User Navigation Header */}
      <header className="home-navbar">
        <div className="nav-content">
          <Link to="/home" className="brand-logo-wrap">
          ...
          <nav className="desktop-nav-links" style={{ display: 'flex', gap: '24px', alignItems: 'center' }}>
            <Link to="/home" className="nav-link-item" style={{ display: 'flex', alignItems: 'center', gap: '6px', textDecoration: 'none', color: '#334155', fontWeight: '500' }}><Home size={18} /> Home</Link>
